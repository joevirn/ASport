...
if (strlen($_SESSION['ASportBusinessSessionCounter'] == 0)) {
	...
	$sql = "SELECT * FROM userBookings WHERE bookingVenue='$businessName' AND bookingIsCancelled IS NOT NULL";
	$result = mysqli_query($con,$sql);
...
?>
	...
	<head>
		...
		<title>ASport for Business | Cancelled Bookings</title>
		<?php
		...
		<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			...
			<div class="row">
				...
				<ol class="breadcrumb">
					...
					<li class="active">Bookings Management -> Cancelled</li>
					<!--end of list-->
				</ol>
				<!--end of ordered list-->
			</div>
