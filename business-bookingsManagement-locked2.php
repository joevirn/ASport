		...
		<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			...
			<div class="row">
				...
				<ol class="breadcrumb">
					...
					<li class="active">Bookings Management -> Locked -> <?php echo $categoryName;?></li>
					<!--end of list-->
				</ol>
				<!--end of ordered list-->
			</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="panel panel-primary">
						<div class="panel-heading">Add & Manage Locked Slots</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-7">
					<div class="panel panel-default">
						<div class="panel-body">
							<h3 align="center"><b>Lock A Slot</b></h3>
								<div class="col-md-1"></div>
								<div class="col-md-10">

									<script src="js/jquery-1.11.1.min.js"></script>
									<form action="" method="post" id="formForAvailabilityCheck">
										<h5><b>Step 1: Select Preferred Date</b></h5>
				...
				?>
					<?php if ($businessFacilityCategoryID==1) { ?>
						<div class="col-md-5">
							<a href="business-bookingsManagement-locked1.php">
								<div class="panel panel-default">
