	...
	<body>
		...
		<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			...
			<div class="row">
	            ...
	            <form role="form" method="post" action="user-bookings-new-relausportscomplex-confirmation.php">
	              <div class="col-md-1"></div>
	                ...
	                <div class="form-group">
	                  ...
	                  <input class="form-control" type="date" name="bookingDate" required="true">
									...
									<div class="form-group">
										<label><span class="fa fa-calendar"></span>&nbsp Select Available Slot to Book</label>
										<table id="legend">
											<tr>
