...
if(isset($_POST['login']))
  {
    ...
    $query = mysqli_query($con,"SELECT businessID FROM business WHERE businessEmail='$email' AND businessPassword='$password' ");
    $ret = mysqli_fetch_array($query);

    if($ret>0){
      $_SESSION['ASportBusinessSessionCounter'] = $ret['businessID'];
...
<head>
	...
	<title>ASport for Business | Login</title>
  <?php
    ...
    echo $msg;
              ...
              <input class="form-control" placeholder="Password" name="password" type="password" value="" required="true">
						...
						<div class="checkbox">
  						...
  						<p style="text-align: center;"><b>Not registered? <a href="business-register.php">Register Now</b></a></p>
