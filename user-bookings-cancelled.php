...
if (strlen($_SESSION['ASportUserSessionCounter'] == 0)) {
	...
	$sql = "SELECT * FROM userBookings WHERE userID=$userID AND bookingIsCancelled IS NOT NULL";
...
?>
	...
	<head>
		...
		<title>ASport | Cancelled Bookings</title>
		<?php
		...
		<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
			...
			<div class="row">
				...
				<ol class="breadcrumb">
					...
					<li class="active">My Bookings -> Cancelled</li>
					<!--end of list-->
				</ol>
				<!--end of ordered list-->
			</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="panel panel-primary">
						<div class="panel-heading">Cancelled Bookings</div>
					</div>
				</div>
			</div>
	      ...
	      <div class="col-md-12">
	        <div class="panel panel-default">
	          <div class="panel-body easypiechart-panel">
	            <h3><b><span class="fa fa-times"></span><br>Cancelled Bookings</b></h3>
	                ...
	                <thead>
	                  <tr>
	                    ...
	                    <th style="text-align: center"><span class="fa fa-th-large"></span><br>Category</th>
											...
											<th style="text-align: center"><span class="fa fa-times"></span><br>Cancellation Date</th>
	                    ...
	                    <tr>
	                      ...
	                      <td><?php echo $row['bookingDuration'];?></td>
						            ...
						            <td><?php echo $row['userBookingID'];?></td>
												<td style="color:red"><b><?php echo $row['bookingIsCancelledTimeStamp'];?></b></td>
